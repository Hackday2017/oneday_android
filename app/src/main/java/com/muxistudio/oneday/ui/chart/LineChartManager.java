...
public class LineChartManager {
    ...
    private static final int AXIS_COLOR = Color.TRANSPARENT;
    ...
    private void initLineChart() {
        ...
        lineChart.setBorderColor(AXIS_COLOR);
        lineChart.setBackgroundColor(AXIS_COLOR);
        lineChart.setGridBackgroundColor(AXIS_COLOR);
        lineChart.setNoDataTextColor(AXIS_COLOR);
        lineChart.setDrawingCacheBackgroundColor(AXIS_COLOR);
        ...
        legend.setTextColor(AXIS_COLOR);
        //显示位置
        ...
        xAxis.setGridColor(AXIS_COLOR);
        xAxis.setTextColor(AXIS_COLOR);
        xAxis.setAxisLineColor(AXIS_COLOR);
        //保证Y轴从0开始，不然会上移一点
        leftAxis.setAxisMinimum(0f);
        leftAxis.setGridColor(AXIS_COLOR);
        leftAxis.setTextColor(AXIS_COLOR);
        leftAxis.setZeroLineColor(AXIS_COLOR);
        leftAxis.setAxisLineColor(AXIS_COLOR);
        rightAxis.setGridColor(AXIS_COLOR);
        rightAxis.setTextColor(AXIS_COLOR);
        rightAxis.setZeroLineColor(AXIS_COLOR);
        rightAxis.setAxisLineColor(AXIS_COLOR);
    }
...
//        lineDataSet.setCircleColor(color);
        ...
        lineDataSet.setValueTextColor(AXIS_COLOR);
    ...
    public void showLineChart(List<Float> xAxisValues, List<Float> yAxisValues, String label, int color) {
        ...
        lineDataSet.setCircleColor(AXIS_COLOR);
        lineDataSet.setFillColor(AXIS_COLOR);
